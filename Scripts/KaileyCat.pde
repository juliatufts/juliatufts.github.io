/* @pjs preload="/Scripts/Resources/KaileyCat.png, /Scripts/Resources/KaileyCatLungs.png"; 
   font="/Scripts/Resources/Minecraftia.ttf"; */ 
PImage background;
PImage lungs;
int epsilon = 6;
...
void setup() {
  size(512, 512);
  background = loadImage("/Scripts/Resources/KaileyCat.png");
  lungs = loadImage("/Scripts/Resources/KaileyCatLungs.png");
  colorMode(HSB);
  textFont(createFont("Minecraftia", 64));
